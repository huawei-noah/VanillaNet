...
| name | Params(M) | FLOPs(B) | Acc(%) | Latency(ms) <br/>Pytorch <br/>A100 | Latency(ms) <br/>MindSpore <br/>Ascend 910 | Latency(ms) <br/>TRT FP32 <br/>A100 | Latency(ms) <br/>TRT FP16 <br/>A100 |  Latency(ms) <br/>TRT FP16 <br/>V100 |
|:---:|:---:|:---:|:---:| :---:|:---:|:---:|:---:|:---:|
